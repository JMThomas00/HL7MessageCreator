...
class HL7MessageApp:
    ...
    def open_help(self):
        ...
        # Help content with clear section markers
        help_content = """
            ...
            **Table of Contents**
            ...
            - [Managing Procedures]
            - [Assigning Staff and Surgeons]
            - [Generating and Saving Messages]
            - [Editor Mode]
            - [Opening HL7 Files]
            - [Navigating Messages]
            - [Editing Messages]
            ...
            **Introduction** 
            The HL7 Message Creator and Editor is a user-friendly tool designed to generate and modify HL7 messages for healthcare scheduling and case events. 
            It offers two modes: **Creator Mode** for building new messages and **Editor Mode** for modifying existing ones. This manual provides step-by-step guidance 
            to help new users master the application.
            ...
            **Editor Mode**
            This section to be complete at a later time.
            """
    ...
    def setup_creator(self):
        ...
        tk.Button(self.creator_button_frame_bottom, text="Add New Procedure", command=self.add_procedure, fg=TEXT_COLOR, bg=BG_COLOR, font=DEFAULT_FONT).pack(side=tk.LEFT, padx=5)
...
base_prompts = [
    ...
    {"prompt": "Case status:", "key": "{encounterType}"},
...
procedure_fields = [
    {"prompt": "Procedure:", "key": "{procedure}"},
    {"prompt": "Procedure ID:", "key": "{procedureId}"},
    {"prompt": "Description:", "key": "{procedureDescription}"},
    {"prompt": "Special Needs:", "key": "{specialNeeds}"},
]
