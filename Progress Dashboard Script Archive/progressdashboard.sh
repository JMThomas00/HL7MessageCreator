...
if process_folder "PreviousDay" "Processed/Yesterday" "$YESTERDAY" 1000 1 true &&
   process_folder "CurrentDay"  "Processed/Today"     "$TODAY"     1100 1 true &&
   process_folder "NextDay"     "Processed/Tomorrow"  "$TOMORROW"  1300 1 false; then
