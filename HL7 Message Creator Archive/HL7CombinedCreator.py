...
class HL7MessageApp:
    ...
    def setup_creator_tab(self):
        ...
        # Main container
        self.creator_main_container = tk.Frame(self.creator_tab, bg=BG_COLOR)
    ...
    def setup_editor_tab(self):
        ...
        self.editor_content_frame = tk.Frame(self.editor_tab, bg=BG_COLOR)
    ...
    def editor_manual_edit_block(self):
        if 0 <= self.current_block < len(self.patient_blocks):
            ...
            # Add Random Patient button for manual editing
