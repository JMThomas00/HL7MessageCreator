...
class HL7MessageCreator:
    def __init__(self, root):
        ...
        self.separator = tk.Frame(self.main_container, width=5, bg="#3A3C5A", cursor="size_we")
    ...
    def setup_base_prompts(self):
        ...
        for i, role_info in enumerate(self.fixed_roles):
            ...
            last_entry = UppercaseEntry(row_frame, bg=PREVIEW_BG, fg=TEXT_COLOR, insertbackground=TEXT_COLOR, width=20)
            last_entry.pack(side=tk.LEFT, padx=5)
            first_entry = UppercaseEntry(row_frame, bg=PREVIEW_BG, fg=TEXT_COLOR, insertbackground=TEXT_COLOR, width=20)
    ...
    def add_staff_fields(self, staff):
        ...
        last_entry = UppercaseEntry(row_frame, textvariable=staff["lastName"], bg=PREVIEW_BG, fg=TEXT_COLOR, insertbackground=TEXT_COLOR, width=20)
        last_entry.pack(side=tk.LEFT, padx=5)
        first_entry = UppercaseEntry(row_frame, textvariable=staff["firstName"], bg=PREVIEW_BG, fg=TEXT_COLOR, insertbackground=TEXT_COLOR, width=20)
        first_entry.pack(side=tk.LEFT, padx=5)
    ...
    def build_template(self, patient):
        """Build the HL7 template with staff and procedures."""
